                            ...
                            <a>
                                <div class="content">
                                    ...
                                    <figure class="myimg">
                                        ...
                                        @else
                                        @if ($item->gender == 1)
                                        <a href="{{ \App\Common::getUserUrl($item->id) }}"><img src="{{ url('assets/defaults/profilepic.png') }}"
                                                class="img-thumbnail" alt="a" height="70" width="70" /></a>
                                        @else
                                        <a href="{{ \App\Common::getUserUrl($item->id) }}"><img src="{{ url('assets/defaults/profilepicfemale.png') }}"
                                                class="img-thumbnail" alt="a" height="70" width="70" /></a>
                                        @endif

                                        @endif
                                    </figure>
                                    <a href="{{ \App\Common::getUserUrl($item->id) }}"><span style="font-size: 13px;"><b>{{
                                                $item->first_name . ' ' . $item->last_name }}</b></span><br /></a>
                    ...
                    <div class="story_row">
                        ...
                        <div class="success_story col-sm-4">
                            <div class="story_item">
                                <img src="{{ asset('images/stories/stories-') }}{{ $item->id }}.{{ $item->image }}" alt=" ">
