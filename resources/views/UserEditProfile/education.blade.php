                            ...
                            <form class="padding-0-30 margin-bottom-20" method="POST" action="{{ $formAction }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input value="{{ $old->education_area }}" id="earea" name="earea" placeholder="Education Area" class="form-control here"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <input value="{{ $old->degree_name }}" id="dname" name="dname" placeholder="Degree Name" class="form-control here"
                                            required="required" type="text">
                                        @if ($errors->has('dname'))
                                        <span class="text-danger" role="alert">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input value="{{ $old->institution_name }}" id="iname" name="iname" placeholder="Institution Name" class="form-control here"
                                            required="required" type="text">
                                        @if ($errors->has('iname'))
                                        <span class="text-danger" role="alert">
