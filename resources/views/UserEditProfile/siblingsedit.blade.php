                            ...
                            <form class="padding-0-30 margin-bottom-20" method="POST" action="{{ $formAction }}" role="form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <div class="radio">
                                                <label>
                                                    <input class="gendercheck" {{ 1 == $old->gender ? 'checked' : '' }}
                                                        type="radio" name="gender" id="gender" value="1">
                                                    Male
                                                </label>
                                                <label>
                                                    <input class="gendercheck" {{ 2 == $old->gender ? 'checked' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <input {{ 1 == $old->living_status ? 'checked' : '' }} type="radio" name="sibling_living"
                                                id="sibling_living1" value="1" class="liveStatusClass livCheck" />
                                            Alive
                                            <input {{ 2 == $old->living_status ? 'checked' : '' }} type="radio" name="sibling_living"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <select name="sibling_profession" id="sibling_profession" class="form-control">
                                                    ...
                                                    <option {{ $old->sibling_profession == $key ?'selected': '' }}
                                        ...
                                        <div class="col-md-6">
                                            <div id="professiondetails" class="allHideClass" style="display:none">
                                                ...
                                                <label for="profession_details" class="col-form-label">Profession
                                                    Details</label>
                                                <div class="">
                                                    <select data-oldval="{{ $old->sibling_profession_details ?? 0 }}"
                                                        name="profession_details" id="profession_details" class="form-control">
                                    ...
                                    <div id="ProfDetailsIdHide" style="display:none">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                    <input value="{{ $old->sibling_designation }}" id="sibling_designation"
                                                        name="sibling_designation" class="form-control here" type="text">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                    <input value="{{ $old->sibling_organization }}" id="sibling_organization"
                                ...
                                <div class="spouse-infos">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <input {{ 1 == $old->sibling_spouse_living_status ? 'checked' : '' }}
                                                    type="radio" name="sibling_spouse_living" id="sibling_spouse_living1"
                                                    value="1" class="liveStatusClassRS" />
                                                Alive
                                                <input {{ 2 == $old->sibling_spouse_living_status ? 'checked' : '' }}
                                                    type="radio" name="sibling_spouse_living" id="sibling_spouse_living"
                                                    value="2" class="liveStatusClassRS" />
                                                Passed Away
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                  ...
                                                  <option value="">Select One</option>
                                                            @foreach (professionType() as $key=>$item)
                                                            <option {{ $old->sibling_spouse_profession == $key ?'selected':'' }}  value="
                                                        {{ $key }}">{{ $item }}</option>
                                                            @endforeach
                                                            </select>
                                            ...
                                            <div class="col-md-6">
                                                <div id="professiondetails1" class="allHideClass2" style="display:none">
                                                    ...
                                                    <label for="spouse_profession_details" class="col-form-label">Profession
                                                        Details</label>
                                                    <div class="">
                                                        <select data-oldval="{{ $old->sibling_spouse_profession_details ?? 0 }}"
                                        ...
                                        <div id="SpouseProfession" style="display: none">
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="{{ $old->sibling_spouse_designation }}" id="sibling_spouse_designation"
                                                            name="sibling_spouse_designation" 
                                                            class="form-control here" type="text">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="{{ $old->sibling_spouse_organization }}" id="sibling_spouse_organizaion"
                                                            name="sibling_spouse_organizaion" 
                                                            class="form-control here" type="text">
