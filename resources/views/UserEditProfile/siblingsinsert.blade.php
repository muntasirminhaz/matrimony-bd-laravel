                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input class="gendercheck"
                                                        {{ 1 == old('gender') ? 'checked' : '' }} type="radio" name="gender"
                                                        id="gender" value="1">
                                                    Male
                                                </label>
                                                <label>
                                                    <input class="gendercheck"
                                                        {{ 2 == old('gender') ? 'checked' : '' }} type="radio" name="gender"
                                                        id="gender" value="2">
                                                    Female
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div id="professiondetails" class="allHideClass" style="display:none">
                                                ...
                                                <label for="profession_details" class="col-form-label">Profession
                                                    Details</label>
                                                <div class="">
                                                    <select data-oldval="{{ old('profession_details') ?? 0 }}" name="profession_details"
                                ...
                                <div class="spouse-infos">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <input {{ 1 == old('sibling_spouse_living') ? 'checked' : '' }} type="radio"
                                                    name="sibling_spouse_living" id="sibling_spouse_living1" value="1"
                                                    class="liveStatusClassRS" />
                                                Alive
                                                <input {{ 2 == old('sibling_spouse_living') ? 'checked' : '' }} type="radio"
                                            ...
                                            <div class="col-md-6">
                                                <div id="professiondetails1" class="allHideClass2" style="display:none">
                                                    ...
                                                    <label for="spouse_profession_details" class="col-form-label">Profession
                                                        Details</label>
                                                    <div class="">
                                                        <select data-oldval="{{ old('spouse_profession_details') ?? 0 }}"
                                        ...
                                        <div id="SpouseProfession" style="display: none">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="{{ old('sibling_spouse_organizaion') }}" id="sibling_spouse_organizaion"
