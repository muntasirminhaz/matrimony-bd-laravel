                            ...
                            <div class="mylocation">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select data-oldval="{{ Auth::user()->location_district }}" name="districts" id="districts" class="form-control"
                                            required="required">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="upzila" data-oldval="{{ Auth::user()->location_upzila }}" id="upzila" class="form-control"
                                            required="required">
                            ...
                            <div class="familylocation" style="display: none">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="">
                                            <select name="family_living_country" id="family_living_country" class="form-control">
                                                <option value="">Select ...</option>
                                                @foreach ($countries as $item)
                                                <option {{ Auth::user()->location_family_living_country == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{
                                                    $item-> name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6 familydeshi">
                                        ...
                                        <select data-oldval="{{ Auth::user()->location_family_district }}" name="family_districts" id="family_districts"
                                            class="form-control addrequired">
                                            <option value="">Select Family District ...</option>
                                            @foreach ($districts as $item)
                                            <option {{ Auth::user()->location_family_district == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{
                                                $item-> name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row familydeshi">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="">
                                            <input value="{{ Auth::user()->location_family_living_area }}" id="family_living_area" name="family_living_area"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="">
                                            <input value="{{ Auth::user()->location_family_zip }}" id="family_zip_code" name="family_zip_code"
                                                 class="form-control addrequired" type="text">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="margin-top-5">
                                            <label>
                                                <input {{ Auth::user()->location_family_residential_status == 1 ? 'checked' : '' }} type="radio"
                                                    class="addrequired family_residential_status" name="family_residential_status"
                                                    value="1">
                                                Owner
                                            </label>
                                            <label>
                                                <input {{ Auth::user()->location_family_residential_status == 2 ? 'checked' : '' }} type="radio"
                                                    class="addrequired family_residential_status" name="family_residential_status"
                                                    value="2">Rental
                                                Rental
                                            </label>
