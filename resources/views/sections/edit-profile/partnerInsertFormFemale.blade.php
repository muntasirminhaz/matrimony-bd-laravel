<form id="insertpreference" method="POST" action="{{ route('users.editprofile.partner.insert') }}" class="padding-0-30"
    style="display: block;">
    @csrf
    <div class="form-group row">
        <h2>Groom (Partner) Preference</h2>
        <small>How do you like your Groom?</small>
        <hr>
    </div>
    <div class="form-group row">
