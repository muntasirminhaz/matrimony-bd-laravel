                ...
                <div class="col-md-12">
                    ...
                    <div id="dropnav" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav mobile-margin-top-60">
                            ...
                            <li>
                                <a href="{{ route('users.photos') }}"><span class="fa fa-picture-o"></span>
                                    Pictures</a>
                            </li>
                            <li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            @auth
                            <li>
                                <a class="dropdown-item outline-0" href="{{ route('logout') }}" onclick="event.preventDefault();
                            ...
                            <li>
                                <!-- login modal trigger -->
                                <a class="outline-0" href="#loginModal" data-toggle="modal" data-target="#loginModal">
