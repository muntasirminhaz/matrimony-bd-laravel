        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="navbar-header brandmobilecenter ">
                    ...
                    <button type="button" class="navbar-toggle collapsed pull-left" data-toggle="collapse" data-target="#dropnav"
                        aria-expanded="false" aria-controls="dropnav">
                ...
                <div id="dropnav" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav mobile-margin-top-60">
                        ...
                        <li>
                            <a href="{{ route('users.photos') }}"><span class="fa fa-photo"></span>
                                Photos</a>
                        </li>
                        <li>
                            <a href="#"><span class="fa fa-search"></span> Search Profiles</a>
                        </li>
                        @else
            ...
            <div class="col-md-12">
                ...
                <div class="navbar-header brandmobilecenter ">
                    ...
                    <a href="{{ url('/') }}" class="navbar-brand padding-0 margin-0 border-0 border-radius-0 logo-fix">
                        <img class="img-responsive logo" src="{{ asset('assets/img/home-logo.png') }}" />
                        <!--         
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99 58" className="MainMenuTall__logo__svg__3tpY7" class="MainMenuTall__logo__svg__3tpY7">
                ...
                <div id="dropnav" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('users.myprofile') }}"><span class="fa fa-user-o"></span> My Profile</a></li>
                                <li><a href="{{ route('users.photos.index') }}"><span class="fa fa-file-photo-o"></span> My Photos</a></li>
                                <li><a href="#"><span class="fa fa-bookmark-o"></span> Shortlist</a></li>
                                <li><a href="#"><span class="fa fa-envelope-o"></span> Messages</a></li>
                                <li role="separator" class="divider"></li>
                                <li class="dropdown-header">Account and Profile Settings</li>
                                <li><a href="{{ route('users.editprofile.account.view') }}"><span class="fa fa-edit"></span>
                                        Edit
                                        My Profile</a></li>
                                <li>
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" action="/action_page.html">
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-sm-5 text-align-left" for="email">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-5 text-align-left" for="pwd">
