    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                ...
                <a class="btn- btn-sm btn-linkedin pull-right" href="{{ route('admin.adminAccount.index') }}">
                    <span class="fa fa-user-circle-o"></span>
                    View Your Profile
                </a>
            </div>
            <form action="{{ route('admin.adminAccount.update') }}" method="post" class="form-horizontal">
                @csrf
