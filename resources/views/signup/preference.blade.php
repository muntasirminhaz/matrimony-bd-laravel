...
<div class="container margin-50">
    ...
    <div class="row padding-0">
        ...
        <div class="col-md-8 col-sm-12 center-block bg-warning ">
            ...
            <form novalidate class="padding-0-30 margin-bottom-20" method="POST" action="{{ route('signup.storePreference') }}"
                role="form">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-4 padding-0">
                        ...
                        <div class="col-sm-6  padding-">
                            <input value="{{ old('minage') }}" id="minage" name="minage" placeholder="Min Age" class="form-control here"
                                type="text">
                        ...
                        <div class="col-sm-6 padding-">
                            <input value="{{ old('maxage') }}" id="maxage" name="maxage" placeholder="Max Age" class="form-control here"
                                type="text">
                            ...
                            <div class="radio">
                                <label class="margin-right-10">
                                    <input class="chilAlow" required="required"
                                        {{ old('childallow') == 1? 'checked' : '' }} type="radio" name="childallow"
                                        value="1">
                                    Yes
                                </label>
                                <label class="margin-right-10">
                                    <input class="chilAlow" required="required"
                                        {{ old('childallow') == 2? 'checked' : '' }} type="radio" name="childallow"
                                        value="2">
                                    No
                                </label>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="">
                            <select name="education[]" class="form-control" id="education" multiple="multiple">
                                ...
                                <option {{ old('education') == $key ? 'selected' : '' }} value="{{ $key }}">{{ $value
                                    }}</option>
                                @endforeach
                            </select>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <select name="familydistrict[]" class="form-control" id="familydistrict" multiple>
                            ...
                            <option {{ old('height') == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{
                                $item->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input value="{{ old('familycity')}}" id="familycity" name="familycity" placeholder="Family Resident City"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="radio">
                            <label>
                                <input class="familResid" {{  old('familyresidentstatus') == 1 ? 'checked' : '' }}
                                    required="required" type="radio" name="familyresidentstatus" value="1">
                                Owner
                            </label>
                            <label>
                                <input class="familResid" {{  old('familyresidentstatus') == 2 ? 'checked' : '' }}
                                    required="required" type="radio" name="familyresidentstatus" value="2">
                                Rental
                            </label>
                            <label>
                                <input class="familResid" {{  old('familyresidentstatus') == 3 ? 'checked' : '' }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="padding-10-0">
                            <label>
                                <input class="Disabl" required="required" {{ old('disablity') == 1 ? 'checked' :'' }}
                                    type="radio" name="disablity" id="nodisability" value="1">
                                No.
                            </label>
                            <label>
                                <input class="Disabl" required="required" {{ old('disablity') == 2 ? 'checked' :'' }}
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <div class="padding-10-0">
                            <label>
                                <input class="claNrb" required="required" {{ old('nrb') == 1 ? 'checked' :'' }} type="radio"
                                    name="nrb" id="nrb1" value="1">
                                Yes
                            </label>
                            <label>
                                <input class="claNrb" required="required" {{ old('nrb') == 2 ? 'checked' :'' }} type="radio"
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="">
                            <textarea placeholder="Provide some additional preference about partner." class="form-control"
                                name="describe" id="describe" cols="30" rows="4">{{ old('describe') }}</textarea>
