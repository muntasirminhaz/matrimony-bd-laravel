...
class UserInterestController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        Mail::to($receiver->email)->send(new DefaultMail(
            'Sobody expressed Interest to you.',
            'Sobody expressed Interest to you.',
            $sender . ' has expressed interest on you. Please <a href="' . route('users.myInterests') . '">login</a> to check or delete the interest.<br> Thank You.<br>Matrimony'
        ));
