                            ...
                            <form class="padding-0-30 margin-bottom-20" method="POST" action="<?php echo e($formAction); ?>" role="form">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="number" name="siblingposition" id="siblingposition"
                                            value="<?php echo e($old->sibling_position); ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <div class="radio">
                                                <label>
                                                    <input class="gendercheck" <?php echo e(1 == $old->gender ? 'checked' : ''); ?>

                                                        type="radio" name="gender" id="gender" value="1">
                                                    Male
                                                </label>
                                                <label>
                                                    <input class="gendercheck" <?php echo e(2 == $old->gender ? 'checked' : ''); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <input <?php echo e(1 == $old->living_status ? 'checked' : ''); ?> type="radio" name="sibling_living"
                                                id="sibling_living1" value="1" class="liveStatusClass livCheck" />
                                            Alive
                                            <input <?php echo e(2 == $old->living_status ? 'checked' : ''); ?> type="radio" name="sibling_living"
                                        ...
                                        <div class="col-md-6">
                                            <div id="professiondetails" class="allHideClass" style="display:none">
                                                ...
                                                <label for="profession_details" class="col-form-label">Profession
                                                    Details</label>
                                                <div class="">
                                                    <select data-oldval="<?php echo e($old->sibling_profession_details ?? 0); ?>"
                                ...
                                <div class="spouse-infos">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <input <?php echo e(1 == $old->sibling_spouse_living_status ? 'checked' : ''); ?>

                                                    type="radio" name="sibling_spouse_living" id="sibling_spouse_living1"
                                                    value="1" class="liveStatusClassRS" />
                                                Alive
                                                <input <?php echo e(2 == $old->sibling_spouse_living_status ? 'checked' : ''); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div id="professiondetails1" class="allHideClass2" style="display:none">
                                                    ...
                                                    <label for="spouse_profession_details" class="col-form-label">Profession
                                                        Details</label>
                                                    <div class="">
                                                        <select data-oldval="<?php echo e($old->sibling_spouse_profession_details ?? 0); ?>"
                                        ...
                                        <div id="SpouseProfession" style="display: none">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="<?php echo e($old->sibling_spouse_organization); ?>" id="sibling_spouse_organizaion"
