<?php $__env->startSection('title', 'Make a new Admin Account'); ?>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form novalidate enctype="multipart/form-data" class="form-horizontal" method="POST" action="<?php echo e(route('admin.adminMgt.store')); ?>">
                <?php echo csrf_field(); ?>
