<?php $__env->startSection('title', 'Add a new Package'); ?>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form novalidate enctype="multipart/form-data" class="form-horizontal" method="POST" action="<?php echo e(route('admin.packages.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="box-footer">
                    <a href='<?php echo e(route('admin.packages.index')); ?>' class="btn btn-default">Cancel Saving Package</a>
