...
<div class="container margin-50">
    ...
    <div class="row padding-0">
        ...
        <div class="col-md-8 col-sm-12 center-block bg-warning ">
            ...
            <form class="padding-0-30 margin-bottom-20" method="POST" action="<?php echo e(route('signup.storeSiblingNumber')); ?>"
                ...
                <div class="form-group row">
                    <div class="col-xs-12">
                        ...
                        <div class="">
                            <input required="required" <?php echo e(old('havesiblings') == 1 ? 'checked':''); ?> type="radio" name="havesiblings"
                                class="havesiblings chekhavesiblings" value="1" />
                            No
                            <input required="required" <?php echo e(old('havesiblings') == 2 ? 'checked':''); ?> type="radio" name="havesiblings"
                ...
                <div class="col-xs-12 moreinfo">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 ">
                            <div class="">
                                <input min="0" value="<?php echo e(old('brothersnumber')); ?>" id="brothersnumber" name="brothersnumber"
                        ...
                        <div class="col-sm-2 ">
                            <div class="">
                                <input min="0" value="<?php echo e(old('brothersnmarriedumber')); ?>" id="brothersmarriednumber"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2 ">
                            <div class="">
                                <input min="0" value="<?php echo e(old('sistersnumber')); ?>" id="sistersnumber" name="sistersnumber"
                                    class="form-control addrequired" type="number" max="20">
                        ...
                        <div class="col-sm-2 ">
                            <div class="">
                                <input min="0" value="<?php echo e(old('sistersnmarriedumber')); ?>" id="sistersmarriednumber" name="sistersmarriednumber"
                                    class="form-control addrequired" type="number" max="20">
