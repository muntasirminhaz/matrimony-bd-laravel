...
<title><?php echo e($user['name']); ?> - <?php echo e($user['id']); ?></title>
...
<h3 class="text-center text-align-center">Personal Information</h3>
<table class="table table-striped  table-borderless">
    <tbody>
        ...
        <tr>
            <td style="width: 35%">Living Area</td>
        ...
        <?php if($key != 'photo'): ?>
        <tr>
            <td style="width: 35%" class=""><?php echo ucwords(str_ireplace('_', ' ', $key))
                ?></td>
...
<h3 class="text-center text-align-center">Partner Preference</h3>
...
<h3 class="text-center text-align-center">Education</h3>
...
<h3 class="text-center text-align-center">Family Information</h3>
...
<h3 class="text-center text-align-center">Relatives Information</h3>
