                            ...
                            <form class="padding-0-30 margin-bottom-20" method="POST" action="<?php echo e($formAction); ?>" role="form">
                                ...
                                <div class="form-group row">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input class="relaFromCheck"
                                                        <?php echo e(1 == $old->relative_side ? 'checked' : ''); ?> type="radio"
                                                        name="relative_side" id="relative_side" value="1">
                                                    Parternal Side
                                                </label>
                                                <label>
                                                    <input class="relaFromCheck"
                                                        <?php echo e(2 == $old->relative_side ? 'checked' : ''); ?> type="radio"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <div class="radio">
                                                <label>
                                                    <input class="genderChek" <?php echo e(1 == $old->gender ? 'checked' : ''); ?>

                                                        type="radio" name="gender" id="gender" value="1">
                                                    Uncle
                                                </label>
                                                <label>
                                                    <input class="genderChek" <?php echo e(2 == $old->gender ? 'checked' : ''); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <input <?php echo e(1 == $old->living_status ? 'checked' : ''); ?> type="radio" name="relative_living"
                                                id="relative_living1" value="1" class="liveStatusClass reltvChecLiv" />
                                            Alive
                                            <input <?php echo e(2 == $old->living_status ? 'checked' : ''); ?> type="radio" name="relative_living"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <select name="relative_profession" id="relative_profession" class="form-control">
                                                    ...
                                                    <option <?php echo e($old->relative_profession == $key ?'selected': ''); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div id="professiondetails" class="allHideClass" style="display:none">
                                                ...
                                                <div class="">
                                                    <select data-oldval="<?php echo e($old->relative_profession_details ?? 0); ?>" name="profession_details"
                                    ...
                                    <div id="ProfDetailsIdHide" style="display:none">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                    <input value="<?php echo e($old->relative_designation); ?>" id="relative_designation"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                    <input value="<?php echo e($old->relative_organization); ?>" id="relative_organization"
                                ...
                                <div class="spouse-infos">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="">
                                                <input <?php echo e(1 == $old->relative_spouse_living_status ? 'checked' : ''); ?> type="radio"
                                                    name="relative_spouse_living" id="relative_spouse_living1" value="1"
                                                    class="liveStatusClassRS" />
                                                Alive
                                                <input <?php echo e(2 == $old->relative_spouse_living_status ? 'checked' : ''); ?> type="radio"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="">
                                                    <select name="relative_spouse_profession" id="relative_spouse_profession"
                                                        ...
                                                        <?php $__currentLoopData = professionType(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php echo e($old->relative_spouse_profession == $key ?'selected':''); ?>  value="
                                            ...
                                            <div class="col-md-6">
                                                <div id="professiondetails1" class="allHideClass2" style="display:none">
                                                    ...
                                                    <div class="">
                                                        <select data-oldval="<?php echo e($old->relative_spouse_profession_details ?? 0); ?>"
                                        ...
                                        <div id="SpouseProfession" style="display: none">
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="<?php echo e($old->relative_spouse_designation); ?>" id="relative_spouse_designation"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="">
                                                        <input value="<?php echo e($old->relative_spouse_organization); ?>" id="relative_spouse_organizaion"
