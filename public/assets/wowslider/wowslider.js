...
(function($){
	...
	var effectsPath = (SITE_URL || 'http://wowslider.com/')+'view/js/effects/';
		...
		if($('#effbuttons').length && !$("#effbuttons .effbutton").length){
			...
			for (var e=0; e<effects.length; e++)
				(function(effect){
					...
					a.click(function(){
						$.getScript(effectsPath+effect+".js", function(){
							callback(effect); 
						});
						return false;
					});
